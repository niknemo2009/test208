...
public class Controller {
    ...
    void initialize() {
        ...
        shpwData.setOnAction(actionEvent -> {
            showRockets();
        });
    ...
    public void removeRocket() {
        ...
        Rocket rocket = new Rocket(rocketModeltoDelete);
        try {
            handler.deleteRocket(rocket);
        } catch (SQLException | ClassNotFoundException e) {
            e.printStackTrace();
        }
    ...
    public void createRocket() {
        ...
        Rocket rocket = new Rocket(rocketPower, rocketModel, rocketMass);
        try {
            handler.addRocket(rocket);
        } catch (SQLException | ClassNotFoundException e) {
            e.printStackTrace();
        }
        if (rocketMass > TOTAL_WEIGHT) {
            ...
            System.out.println("your rocket is too heavy for us v2");
        }
//        }
        else {
    ...
    public void arrive(Object object){
        if (object.getClass() == hodakeys.getClass()) {
            ...
            //Есил масса корабля больше чем вся доступная масса станции тогда их не поскает на станцию
                ...
                System.out.println("Your Rocket is too heavy for our station");
            }
