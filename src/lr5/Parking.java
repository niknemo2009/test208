...
class Parking  {
    ...
    public Parking(String currentMonth, String carModel, Integer countOfParkingTimes, String namePerson, double monthPayment) {
        this.namePerson = namePerson;
        this.countOfParkingTimes = countOfParkingTimes;
        this.carModel = carModel;
        this.currentMonth = Month.valueOf(currentMonth);
        this.monthPayment = monthPayment;
    }
    ...
    static ArrayList<Parking> tempCars = new ArrayList<>();
    @Override
