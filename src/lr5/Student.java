...
public class Student {
    ...
    /*
    static {
        data.add(new Student("Afanasiev", 130.66, 188.01, 101));
        data.add(new Student("Kabina", 150.66, 118.01, 208));
        data.add(new Student("Chertov", 120.66, 138.01, 208));
        data.add(new Student("Uzbek", 122.66, 148.01, 201));
        data.add(new Student("Uvazhaemiy", 150.66, 288.01, 208));
        data.add(new Student("Petrov", 85.67, 172.01, 209));
        data.add(new Student("Alekseev", 90.66, 150.01, 208));
        data.add(new Student("Zabelenkov", 100.16, 120.01, 208));
        data.add(new Student("Skrypnik", 85.66, 175.01, 209));
        data.add(new Student("Mokrivskiy", 99.11, 151.01, 208));
    }
